...
local function OpenDialog()
    ...
    dpack:SetPos(m, m + 25)
    dpack:StretchToParent(m, nil, m + 5 * (m + 22), nil)
    ...
    dsavebutton:SetPos(w - 2 * (m + 22), m + 25)
    dsavebutton:SetText("")
    ...
    ddeletebutton:SetPos(w - 3 * (m + 22), m + 25)
    ...
    drenamebutton:SetPos(w - 4 * (m + 22), m + 25)
    ...
    dnewbutton:SetPos(w - 5 * (m + 22), m + 25)
    dnewbutton:SetText("")
