...
local informant_show_scan_radius = CreateConVar("ttt_informant_show_scan_radius", "0")
...
hook.Add("TTTSyncGlobals", "Informant_TTTSyncGlobals", function()
    ...
    SetGlobalBool("ttt_informant_show_scan_radius", informant_show_scan_radius:GetBool())
