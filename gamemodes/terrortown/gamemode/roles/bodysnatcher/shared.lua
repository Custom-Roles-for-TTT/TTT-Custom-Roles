...
CreateConVar("ttt_bodysnatcher_swap_role", "0", FCVAR_REPLICATED, "Whether the bodysnatcher's target should become a bodysnatcher", 0, 1)
...
table.insert(ROLE_CONVARS[ROLE_BODYSNATCHER], {
    cvar = "ttt_bodysnatcher_swap_role",
    type = ROLE_CONVAR_TYPE_BOOL
})
table.insert(ROLE_CONVARS[ROLE_BODYSNATCHER], {
