...
AddHook("Initialize", "Impersonator_Shared_Initialize", InitializeEquipment)
AddHook("TTTPrepareRound", "Impersonator_Shared_TTTPrepareRound", InitializeEquipment)

AddHook("TTTRoleSpawnsArtificially", "Impersonator_TTTRoleSpawnsArtificially", function(role)
