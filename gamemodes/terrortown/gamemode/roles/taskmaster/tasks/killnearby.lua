...
if SERVER then
    util.AddNetworkString("TTT_Taskmaster_KillNearby_Assigned")
    util.AddNetworkString("TTT_Taskmaster_KillNearby_Cleanup")
    ...
    TASK.OnTaskAssigned = function(ply)
        hook.Add("PlayerDeath", "Taskmaster_KillNearby_PlayerDeath_" .. ply:SteamID64(), function(victim, inflictor, attacker)
        ...
        net.Start("TTT_Taskmaster_KillNearby_Assigned")
        net.Send(ply)
    end
...
if CLIENT then
    net.Receive("TTT_Taskmaster_KillNearby_Assigned", function()
        ...
        hook.Add("TTTTargetIDPlayerText", "Taskmaster_KillNearby_TTTTargetIDPlayerText_" .. sid64, function(ent, cli, text, col, secondaryText)
            ...
            if distanceSqr <= rangeSqr then
                ...
                return "TOO FAR", ROLE_COLORS_RADAR[ROLE_TRAITOR]
            end
        end)
    ...
    net.Receive("TTT_Taskmaster_KillNearby_Cleanup", function()
