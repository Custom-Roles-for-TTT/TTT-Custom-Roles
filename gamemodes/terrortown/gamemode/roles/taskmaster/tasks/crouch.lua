...
local taskmaster_crouch_time = CreateConVar("ttt_taskmaster_crouch_time", "30", FCVAR_REPLICATED, "The time (in seconds) a player must stay crouched to complete the 'Crouch Near Body' task", 1, 240)
