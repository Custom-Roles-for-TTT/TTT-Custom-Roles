...
function ScoreEventLog(events, scores, traitors, detectives, jesters, swappers, glitches, phantoms, hypnotists, romantics, drunks, clowns, deputies, impersonators, beggars)
    for k, s in pairs(scores) do
        ...
        scores[k].was_romantic = table.HasValue(romantics, k)
