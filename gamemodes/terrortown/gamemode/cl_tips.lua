...
local tip_params = {
   [1]  = {walkkey = Key("+walk", "WALK"), usekey = Key("+use", "USE"), traitors = ROLE_STRINGS_PLURAL[ROLE_TRAITOR]},
   [3]  = {detectives = ROLE_STRINGS_PLURAL[ROLE_DETECTIVE]},
   [5]  = {adetective = ROLE_STRINGS_EXT[ROLE_DETECTIVE], atraitor = ROLE_STRINGS_EXT[ROLE_TRAITOR]},
   [6]  = {detectives = ROLE_STRINGS_PLURAL[ROLE_DETECTIVE], atraitor = ROLE_STRINGS_EXT[ROLE_TRAITOR]},
   [7]  = {innocents = ROLE_STRINGS_PLURAL[ROLE_INNOCENT], traitors = ROLE_STRINGS_PLURAL[ROLE_TRAITOR]},
   ...
   [21] = {detective = ROLE_STRINGS[ROLE_DETECTIVE], traitors = ROLE_STRINGS_PLURAL[ROLE_TRAITOR]},
   [22] = {detectives = ROLE_STRINGS_PLURAL[ROLE_DETECTIVE]},
   [23] = {detectives = ROLE_STRINGS_PLURAL[ROLE_DETECTIVE], traitors = ROLE_STRINGS_PLURAL[ROLE_TRAITOR]},
   [24] = {helpkey = Key("+gm_showhelp", "F1")},
   [25] = {adetective = ROLE_STRINGS_EXT[ROLE_DETECTIVE]},
   [26] = {adetective = ROLE_STRINGS_EXT[ROLE_DETECTIVE]},
   [27] = {adetective = ROLE_STRINGS_EXT[ROLE_DETECTIVE]},
...
function PANEL:Init()
    -- Add late-loading tip parameters to the list
    tip_params[30] = {radiokey = GetConVar("ttt_radio_button"):GetString()}
