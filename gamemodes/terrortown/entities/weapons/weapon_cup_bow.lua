...
SWEP.ActivitySound = {}
SWEP.ActivitySound[ACT_VM_PULLBACK] = "Weapon_CupidsBow.Pull"
SWEP.ActivitySound[ACT_VM_PRIMARYATTACK] = "Weapon_CupidsBow.Single"
SWEP.ActivitySound[ACT_VM_LOWERED_TO_IDLE] = "Weapon_CupidsBow.Nock"
SWEP.ActivitySound[ACT_VM_RELEASE] = "Weapon_CupidsBow.Pull"
...
function SWEP:Think()
	...
	elseif self.dt.WepState == self.STATE_NOCKED then
		if self.Owner:KeyDown(IN_ATTACK) and not self.Owner:KeyDown(IN_RELOAD) then
...
if CLIENT then
	...
	function SWEP:PreDrawViewModel(vm, wep, ply)
		...
		local side_speed = math.Clamp(vel:DotProduct(EyeAngles():Right()), -speed_max, speed_max) / speed_max
