...
globals = {
    ...
    "DETECTIVE_ROLES",
    "DOCTOR_CURE_KILL_NONE",
    "DOCTOR_CURE_KILL_OWNER",
    "DOCTOR_CURE_KILL_TARGET",
    ...
    "GLITCH_CHAT_BLOCK_WHILE_UNCONFIRMED",
    ...
    "PLAGUEMASTER_SEARCH_DONT_SHOW",
    "PLAGUEMASTER_SEARCH_SHOW_INFECTED",
    "PLAGUEMASTER_SEARCH_SHOW_KILLED",
    ...
    "SPY_STEAL_MODE_DISABLE",
    "SPY_STEAL_MODE_KILL",
    "SPY_STEAL_MODE_SEARCH",
